...
describe('WizardLayout Component', () => {
  ...
  describe('Basic Rendering', () => {
    ...
    it('should display current step title and subtitle', () => {
      ...
      // Title appears in both sidebar and main content header
      const titles = screen.getAllByText('Basic Information')
      expect(titles.length).toBe(2) // sidebar + step header

      // Subtitle appears in both sidebar and main content
      const subtitles = screen.getAllByText('Enter auction details')
    ...
    it('should render all steps in sidebar', () => {
      ...
      // The active step title appears twice (sidebar + header), others appear once
  ...
  describe('Progress Bar', () => {
    it('should display correct progress for first step', () => {
      ...
      // Progress indicator transform: translateX(-75%) for 25% progress
  ...
  describe('Step Navigation', () => {
    ...
    it('should apply correct styling for active step', () => {
      ...
      // "Basic Information" appears in both sidebar button and main h2
      const allMatches = screen.getAllByText('Basic Information')
      const sidebarButton = allMatches.find(el => el.closest('button'))?.closest('button')
      expect(sidebarButton).toBeDefined()
      expect(sidebarButton).toHaveClass('bg-info/10')
    })
  ...
  describe('Navigation Buttons', () => {
    ...
    it('should show Create Auction button on final step', () => {
      ...
      // "Create Auction" appears in header h1 and as the final step button
      const matches = screen.getAllByText('Create Auction')
      expect(matches.length).toBe(2) // header + button
  ...
  describe('Save Draft Functionality', () => {
    ...
    it('should disable Save Draft button when loading', () => {
      ...
      const saveDraftSpan = screen.getAllByText('Save Draft')[0]
      expect(saveDraftSpan.closest('button')).toBeDisabled()
    })
  })
