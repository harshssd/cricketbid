...
export default function ClubsDashboard() {
  ...
  const clubCode = params.code as string
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-xl font-semibold text-gray-900 mb-4">Club not found</h1>
          <Link href="/dashboard">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-3">
              ...
              {(club.userRole === 'OWNER' || club.userRole === 'ADMIN' || club.userRole === 'MODERATOR') && (
                <Button size="sm" asChild>
                  <Link href={`/leagues/create?club=${clubCode}`}>
                    ...
                    {leagues.map((league) => (
                      ...
                      >
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          {(club.userRole === 'OWNER' || club.userRole === 'ADMIN') && league.isHosted && (
                            <DropdownMenu>
                              ...
                              <DropdownMenuContent align="end">
                                <DropdownMenuItem asChild>
                                  <Link href={`/leagues/${league.code}/settings`}>
              ...
              <CardContent>
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span>{club.maxMembers || 'Unlimited'}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Location</span>
                    <span>{club.location || 'Not set'}</span>
                  </div>
                  <div className="flex justify-between">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              >
                ...
                {club?.userRole === 'OWNER' && <option value="ADMIN">Admin</option>}
              </select>
            </div>
          </div>
          <DialogFooter>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input defaultValue={club?.code} disabled />
                </div>
                <div>
                  <Label>Location</Label>
                  <Input defaultValue={club?.location || 'Not set'} disabled />
                </div>
                <div>
                  <Label>Website</Label>
                  <Input defaultValue={club?.website || 'Not set'} disabled />
                </div>
              </div>
              <div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <div className="mt-2">
                    <span className="text-sm">{club?.maxMembers || 'Unlimited'}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="text-center p-4 bg-gray-50 rounded-lg">
                  <div className="text-2xl font-bold text-green-600">{club?.leagueCount}</div>
                  <div className="text-sm text-gray-600">Leagues</div>
                </div>
                <div className="text-center p-4 bg-gray-50 rounded-lg">
                  <div className="text-2xl font-bold text-purple-600">{leagues.reduce((sum, l) => sum + l.auctionCount, 0)}</div>
            ...
            {club?.userRole === 'OWNER' && (
              <div className="space-y-4">
                ...
                <div className="border border-red-200 rounded-lg p-4 bg-red-50">
                  <div className="flex items-center justify-between">
                    <div>
                      <h4 className="font-medium text-red-900">Delete Club</h4>
